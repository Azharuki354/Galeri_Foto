...
class FotoController extends AppController
{
    ...
    {
        $foto = $this->Foto->get($id, contain: ['Album', 'Users', 'Komentar', 'Likefoto']);
    ...
    public function add()
    {
        ...
        if ($this->request->is('post')) {
            ...
            $foto->lokasifile = $file['images']->getClientFilename();
            $file['images']->moveTo(WWW_ROOT . 'img' . DS . $foto->lokasifile);
    ...
    public function edit($id = null)
    {
        ...
        if ($this->request->is(['patch', 'post', 'put'])) {
            ...
            if(!empty($file['images']->getClientFilename())){
                $foto->foto = $file['images']->getClientFilename();
            $file['images']->moveTo(WWW_ROOT . 'img' . DS . $foto->foto);
            }
            if ($this->Foto->save($foto)) {
                $this->Flash->success(__('The foto has been saved.'));
